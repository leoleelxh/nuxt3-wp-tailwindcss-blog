  ...
  <div>
    ...
    <div>
      ...
      <div id="container" class="absolute text-white text-center w-full max-w-2xl px-6"
        ...
        <h1 id="christopherLis" class="font-space-mono text-sm uppercase tracking-wide text-black"
          style="transform: translateY(30px)">
          Christopher Lis
        </h1>
        <p id="oneWithAn" class="font-exo text-4xl text-black" style="transform: translateY(30px)">
          ONE WITH AN EVERLASTING DESIRE FOR THE UNKNOWN & UNTOLD
        </p>
        <a id="viewWorkBtn" href="https://chriscourses.com/"
          class="border px-4 py-2 rounded-lg text-sm font-space-mono uppercase mt-8 hover:bg-white hover:text-gray-800 inline-block text-blue-400"
          style="transform: translateY(30px)">
          View Work
        </a>
      </div>
